...
export const act4Areas: AreaDefinition[] = [
  ...
  { id: 'act4-abandoned-prison', act: 4, nameKo: '버려진 감옥', nameEn: 'Abandoned Prison', logNamesKo: ['버려진 감옥', 'Abandoned Prison'], isTown: false, hasMapThumbnail: false, needsVerification: true, guideStepIds: ['act4-abandoned-prison-explore'] },
  { id: 'act4-solitary-confinement', act: 4, nameKo: '독방', nameEn: 'Solitary Confinement', logNamesKo: ['독방', 'Solitary Confinement'], isTown: false, hasMapThumbnail: false, needsVerification: true, guideStepIds: ['act4-abandoned-prison-prisoner'] },
  ...
  { id: 'act4-journeys-end', act: 4, nameKo: '여정의 끝', nameEn: "Journey's End", logNamesKo: ['여정의 끝', "Journey's End"], isTown: false, hasMapThumbnail: false, needsVerification: true, guideStepIds: ['act4-dark-mists-captain-hartlin'] },
  { id: 'act4-isle-of-kin', act: 4, nameKo: '친족의 섬', nameEn: 'Isle of Kin', logNamesKo: ['친족의 섬', 'Isle of Kin'], isTown: false, hasMapThumbnail: false, needsVerification: true, guideStepIds: ['act4-land-of-the-kin-isle'] },
  ...
  { id: 'act4-whakapanu-island', act: 4, nameKo: '와카파누 섬', nameEn: 'Whakapanu Island', logNamesKo: ['와카파누 섬', 'Whakapanu Island'], isTown: false, hasMapThumbnail: false, needsVerification: true, guideStepIds: ['act4-whakapanu-diamora', 'act4-tribal-medicine'] },
  { id: 'act4-plunders-point', act: 4, nameKo: '약탈자의 거점', nameEn: "Plunder's Point", logNamesKo: ['약탈자의 거점', "Plunder's Point"], isTown: false, hasMapThumbnail: false, needsVerification: true, guideStepIds: ['act4-forgotten-bounty'] },
  { id: 'act4-halls-of-the-dead', act: 4, nameKo: '망자의 전당', nameEn: 'Halls of the Dead', logNamesKo: ['망자의 전당', 'Halls of the Dead'], isTown: false, hasMapThumbnail: false, needsVerification: true, guideStepIds: ['act4-ngamahu-test', 'act4-tasalio-test', 'act4-tawhoa-test'] },
...
export const act4Checklists: AreaChecklist[] = [
  ...
  objective('act4-abandoned-prison', 'act4-abandoned-prison-explore', '버려진 감옥: 감옥 탐험 후 독방 진입', 'required', '4장 보조 메인 섬 퀘스트'),
  objective('act4-solitary-confinement', 'act4-abandoned-prison-prisoner', '포로: 포로 처치 및 선도자 무기 조각 회수', 'required', '탐색 진행 조각'),
  ...
  objectives('act4-journeys-end', [
    ...
    ['act4-blind-beast', '눈먼 짐승: 눈먼 짐승 처치 및 아황산염 물약/보상 확인', 'required', '4장 한국 서버 퀘스트 목록 기준']
  ]),
  objective('act4-isle-of-kin', 'act4-land-of-the-kin-isle', '혈족의 땅: 혈족의 섬 탐험 후 화산 굴 진입', 'required', '4장 보조 메인 섬 퀘스트'),
  ...
  objective('act4-plunders-point', 'act4-forgotten-bounty', '잊힌 하사품: 찢어진 지도 조각/탐험 보상 진행', 'optional', 'Plunder’s Point 선택 퀘스트'),
  objectives('act4-halls-of-the-dead', [
    ['act4-ngamahu-test', "나마후의 시험: 망자의 전당 시험 완료", 'optional', '카루이 시험 보상'],
    ['act4-tasalio-test', "타살리오의 시험: 망자의 전당 시험 완료", 'optional', '카루이 시험 보상'],
    ['act4-tawhoa-test', "타호아의 시험: 망자의 전당 시험 완료", 'optional', '카루이 시험 보상']
  ]),
  objective('act4-trial-of-the-ancestors', 'act4-trial-ancestors-complete', '선조들의 심판: 히네코라/제단 사용 후 보상 획득', 'optional', '선조 시험 완료'),
